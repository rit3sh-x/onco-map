...
import type { ClinvarVariant, GeneFromSearch } from "@/modules/schema";
...
import { getClassificationColorClasses } from "@/utils/coloring";
...
export default function KnownVariants({
  ...
  const analyzeVariant = async (variant: ClinvarVariant) => {
    ...
    if (!position || !refAltMatch || refAltMatch.length !== 3) return;
  };
                  ...
                  >
                    <TableCell className="py-2">
                      ...
                      <div className="mt-1 flex items-center gap-1 text-xs text-[#3c4f3d]/70">
                        ...
                        <Link
                          href={`${NCBI_NLM_URL}/clinvar/variation/${variant.clinvar_id}`}
                          target="_blank"
                    ...
                    <TableCell className="py-2 text-xs">
                      ...
                      {variant.evo2Result && (
                        <div className="mt-2">
                          <div
                            className={`flex w-fit items-center gap-1 rounded-md px-2 py-1 text-center ${getClassificationColorClasses(
