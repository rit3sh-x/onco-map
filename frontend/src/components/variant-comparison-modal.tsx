import type { ClinvarVariant } from "@/modules/schema";
import { Button } from "./ui/button";
import { Check, ExternalLink, Shield, X } from "lucide-react";
import { getClassificationColorClasses, getNucleotideColorClass } from "@/utils/coloring";
...
export function VariantComparisonModal({ comparisonVariant, onClose }: VariantComparisonModalProps) {
                ...
                <div className="rounded-md border border-[#3c4f3d]/10 bg-white p-4">
                    ...
                    <div className="rounded-md bg-[#e9eeea]/50 p-4">
                      ...
                      <div className="mt-3">
                        ...
                        <div className="mt-1 h-2 w-full rounded-full bg-[#e9eeea]/80">
                          <div
                            className={`h-2 rounded-full ${comparisonVariant.evo2Result.prediction.includes("pathogenic")
                              ? "bg-red-600"
                              : "bg-green-600"
                              }`}
                            style={{
                              width: `${Math.min(
                                100,
                                comparisonVariant.evo2Result.classification_confidence * 100
                              )}%`,
                            }}
                          ></div>
                        </div>
                  ...
                  <div className="mt-4 rounded-md bg-[#e9eeea]/20 p-3 text-xs leading-relaxed">
                    <div className="flex items-center gap-2">
                      <span
                        className={`flex h-5 w-5 items-center justify-center rounded-full ${comparisonVariant.classification.toLowerCase() ===
